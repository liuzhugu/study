...
public final class ReflectUtil_ {
    public static final String PROXY_PACKAGE = "com.sun.proxy";

    private ReflectUtil_() {
    }
    ...
    public static Object newInstance(Class_<?> var0) throws InstantiationException, IllegalAccessException {
        checkPackageAccess(var0);
    ...
    public static void ensureMemberAccess(Class<?> var0, Class<?> var1, Object var2, int var3) throws IllegalAccessException {
        if (var2 == null && Modifier.isProtected(var3)) {
            int var4 = var3 & -5;
            var4 |= 1;
            Reflection.ensureMemberAccess(var0, var1, var2, var4);
            ...
            Reflection.ensureMemberAccess(var0, var1, var2, var3);
        }
    }
    ...
    public static void checkPackageAccess(Class_<?> var0) {
    ...
    public static boolean isPackageAccessible(Class_<?> var0) {
        try {
            checkPackageAccess(var0);
            return true;
    ...
    public static void checkProxyPackageAccess(Class_<?> var0) {
        SecurityManager var1 = System.getSecurityManager();
        if (var1 != null && Proxy_.isProxyClass(var0)) {
            Class_[] var2 = var0.getInterfaces();
    ...
    public static void checkProxyPackageAccess(ClassLoader var0, Class_... var1) {
    ...
    public static boolean isNonPublicProxyClass(Class_<?> var0) {
        String var1 = var0.getName();
        int var2 = var1.lastIndexOf(46);
        String var3 = var2 != -1 ? var1.substring(0, var2) : "";
        return Proxy_.isProxyClass(var0) && !var3.equals("com.sun.proxy");
    }
