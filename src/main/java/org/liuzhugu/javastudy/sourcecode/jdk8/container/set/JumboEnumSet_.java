...
/**
 * Private implementation class for EnumSet_, for "jumbo" enum types
 ...
 * @serial exclude
 */
class JumboEnumSet_<E extends Enum<E>> extends EnumSet_<E> {
    ...
    JumboEnumSet_(Class<E>elementType, Enum<?>[] universe) {
    ...
    public boolean containsAll(Collection<?> c) {
        if (!(c instanceof JumboEnumSet_))
            return super.containsAll(c);

        JumboEnumSet_<?> es = (JumboEnumSet_<?>)c;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof JumboEnumSet_))
            return super.equals(o);

        JumboEnumSet_<?> es = (JumboEnumSet_<?>)o;
        if (es.elementType != elementType)
    ...
    public EnumSet_<E> clone() {
        JumboEnumSet_<E> result = (JumboEnumSet_<E>) super.clone();
