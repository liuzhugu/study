...
public final
class Field_ extends AccessibleObject_ implements Member_ {

    private Class_<?>            clazz;
    private int                 slot;
    // This is guaranteed to be interned by the VM in the 1.4
    // Reflection_ implementation
    private String              name;
    private Class_<?>            type;
    ...
    private GenericsFactory getFactory() {
        Class_<?> c = getDeclaringClass();
        // create scope and factory
        return CoreReflectionFactory_.make(c, ClassScope_.make(c));
    }
    ...
    Field_ copy() {
        ...
        Field_ res = new Field_(clazz, name, type, modifiers, slot, signature, annotations);
        res.root = this;
     ...
     * by this {@code Field} object, as an integer. The {@code Modifier_} class should
    ...
    public boolean isEnumConstant() {
        return (getModifiers() & Modifier_.ENUM) != 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof Field_) {
            Field_ other = (Field_)obj;
    ...
    public String toString() {
        ...
        return (((mod == 0) ? "" : (Modifier_.toString(mod) + " "))
                + getType().getTypeName() + " "
