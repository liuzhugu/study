...
public class AnnotationParser_ {
    private static final Annotation_[] EMPTY_ANNOTATIONS_ARRAY = new Annotation_[0];
    private static final Annotation_[] EMPTY_ANNOTATION_ARRAY = new Annotation_[0];

    public AnnotationParser_() {
    }

    public static Map<Class<? extends Annotation_>, Annotation_> parseAnnotations(byte[] var0, ConstantPool var1, Class<?> var2) {
        if (var0 == null) {
    ...
    @SafeVarargs
    static Map<Class<? extends Annotation_>, Annotation_> parseSelectAnnotations(byte[] var0, ConstantPool var1, Class<?> var2, Class... var3) {
        if (var0 == null) {
            return Collections.emptyMap();
        } else {
            try {
    ...
    private static Map<Class<? extends Annotation_>, Annotation_> parseAnnotations2(byte[] var0, ConstantPool var1, Class<?> var2, Class<? extends Annotation_>[] var3) {
        LinkedHashMap var4 = new LinkedHashMap();
        ByteBuffer var5 = ByteBuffer.wrap(var0);
        int var6 = var5.getShort() & '\uffff';

        for(int var7 = 0; var7 < var6; ++var7) {
            Annotation_ var8 = parseAnnotation2(var5, var1, var2, false, var3);
            if (var8 != null) {
                Class_ var9 = var8.annotationType();
//                if (AnnotationType.getInstance(var9).retention() == RetentionPolicy.RUNTIME && var4.put(var9, var8) != null) {
//                    throw new AnnotationFormatError("Duplicate Annotation_ for class: " + var9 + ": " + var8);
//                }
            }
        }
    ...
    public static Annotation_[][] parseParameterAnnotations(byte[] var0, ConstantPool var1, Class<?> var2) {
        try {
    ...
    private static Annotation_[][] parseParameterAnnotations2(byte[] var0, ConstantPool var1, Class<?> var2) {
        ByteBuffer var3 = ByteBuffer.wrap(var0);
        int var4 = var3.get() & 255;
        Annotation_[][] var5 = new Annotation_[var4][];
        ...
        for(int var6 = 0; var6 < var4; ++var6) {
            ...
            for(int var9 = 0; var9 < var7; ++var9) {
                Annotation_ var10 = parseAnnotation(var3, var1, var2, false);
                if (var10 != null) {
                    //AnnotationType var11 = AnnotationType.getInstance(var10.annotationType());
                    AnnotationType var11 = null;
            ...
            var5[var6] = (Annotation_[])var8.toArray(EMPTY_ANNOTATIONS_ARRAY);
        }

        return var5;
    }

    static Annotation_ parseAnnotation(ByteBuffer var0, ConstantPool var1, Class<?> var2, boolean var3) {
        return parseAnnotation2(var0, var1, var2, var3, (Class[])null);
    }

    private static Annotation_ parseAnnotation2(ByteBuffer var0, ConstantPool var1, Class<?> var2, boolean var3, Class<? extends Annotation_>[] var4) {
...
//                    }
    ...
    public static Annotation_ annotationForMap(final Class<? extends Annotation_> var0, final Map<String, Object> var1) {
        return (Annotation_) AccessController.doPrivileged(new PrivilegedAction<Annotation_>() {
            public Annotation_ run() {
                //return (Annotation_) Proxy_.newProxyInstance(var0.getClassLoader(), new Class_[]{var0}, new AnnotationInvocationHandler(var0, var1));
                return (Annotation_) Proxy.newProxyInstance(var0.getClassLoader(), new Class[]{var0},null);
            }
        });
    }
    ...
    private static Object parseConst(int var0, ByteBuffer var1, ConstantPool var2) {
        ...
        switch(var0) {
            ...
            default:
                throw new AnnotationFormatError("Invalid member-value tag in Annotation_: " + var0);
        }
    }
    ...
    private static Object parseAnnotationArray(int var0, Class<? extends Annotation_> var1, ByteBuffer var2, ConstantPool var3, Class<?> var4) {
        Object[] var5 = (Object[])((Object[])Array.newInstance(var1, var0));
        boolean var6 = false;
        byte var7 = 0;
    ...
    public static Annotation_[] toArray(Map<Class_<? extends Annotation_>, Annotation_> var0) {
        return (Annotation_[])var0.values().toArray(EMPTY_ANNOTATION_ARRAY);
    }

    static Annotation_[] getEmptyAnnotationArray() {
