package org.liuzhugu.javastudy.sourcecode.jdk8;
...
public final class Unsafe_ {
    private static final Unsafe_ theUnsafe;
    ...
    @CallerSensitive
    public static Unsafe_ getUnsafe() {
    ...
    static {
        //registerNatives();
        Reflection.registerMethodsToFilter(Unsafe_.class, new String[]{"getUnsafe"});
        theUnsafe = new Unsafe_();
