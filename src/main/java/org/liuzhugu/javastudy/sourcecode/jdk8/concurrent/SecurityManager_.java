...
public class SecurityManager_ {
    ...
    /**
     * Constructs a new <code>SecurityManager_</code>.
     *
     ...
     */
    public SecurityManager_() {
        synchronized(SecurityManager_.class) {
    ...
    private static ThreadGroup_ rootGroup = getRootGroup();

    private static ThreadGroup_ getRootGroup() {
        ThreadGroup_ root =  Thread_.currentThread().getThreadGroup();
     ...
     * <code>setDaemon</code> methods of class <code>Thread_</code>.
     * <p>
     ...
     * @see        #checkPermission(Permission) checkPermission
     */
    public void checkAccess(Thread_ t) {
        if (t == null) {
     ...
     * <code>destroy</code> methods of class <code>ThreadGroup_</code>.
     * <p>
     ...
     * @see        #checkPermission(Permission) checkPermission
     */
    public void checkAccess(ThreadGroup_ g) {
        if (g == null) {
    ...
    public void checkMemberAccess(Class<?> clazz, int which) {
        ...
        if (which != Member.PUBLIC) {
             ...
             * SecurityManager_.checkMemberAccess [0]
             *
             */
            if ((stack.length<4) ||
     ...
     *
     * @return  ThreadGroup_ that new threads are instantiated into
     * @since   JDK1.1
     */
    public ThreadGroup_ getThreadGroup() {
        return Thread_.currentThread().getThreadGroup();
    }
